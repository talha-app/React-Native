...
const RegisterForm = props => {
    ...
    const [nameValidationInfo, setNameValidationInfo] = useState({borderColor:'gray', borderWidth:1})
    const [emailValidationInfo, setEmailValidationInfo] = useState({borderColor:'gray', borderWidth:1})
    ...
    const onNameChangeText = text => {
        if (text.trim() == "")
            ...
            setNameValidationInfo({borderColor:'gray', borderWidth:1})
    ...
    const onEmailChangeText = text =>  {
        if (text.trim() == "")
            ...
            setEmailValidationInfo({borderColor:'gray', borderWidth:1})
        setEmail(text)
    }
