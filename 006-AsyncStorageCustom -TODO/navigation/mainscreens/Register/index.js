...
import {alertSaveFailText, alertSaveSuccessText, buttonSaveUserText} from '../../../resource/Resource.js';

const RegisterScreen = ({navigation}) => {
    const [username, setUsername] = useState('testUsername');
    const [name, setName] = useState('testName');
    const [email, setEmail] = useState('testName@testName');
    ...
    return (
        <View>
            <TextInput value={username} style={{
                borderColor: usernameValidationInfo.borderColor,
                borderWidth: usernameValidationInfo.borderWidth,
            }}
                       onChangeText={onUsernameChangeText} placeholder="username"/>
            <TextInput value={name} style={{
                borderColor: nameValidationInfo.borderColor,
                borderWidth: nameValidationInfo.borderWidth,
            }}
                       onChangeText={onNameChangeText} placeholder="name"/>
            <TextInput value={email} style={{
                borderColor: emailValidationInfo.borderColor,
                borderWidth: emailValidationInfo.borderWidth,
            }}
